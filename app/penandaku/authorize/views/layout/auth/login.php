    ...
    <div class="container" style="margin-top:80px">
      ...
      <div class="col-md-4">
          ...
          <div class="panel panel-default" style="font-family:'ubuntu'">
            <div class="panel-body">
              <?php
                ...
                echo form_open('authorize/', $attributes)
                ?>
                ...
                <div class="form-group">
                  <label style="font-weight:normal">Password <a href="<?php print base_url() ?>forgot/">(forgot password)</a></label>
        ...
        <div class="create-account" style="font-family:'ubuntu'">
          Kembali ke <a href="<?php print base_url() ?>">Beranda</a>.
        </div>
      </div>
      <div class="col-md-4">
      </div>
