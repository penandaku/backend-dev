<div class="statics-page" style="background-image: url('<?php print cdn('img/bg.png') ?>'); position:relative;background-color:#2cb0a3">
  <div class="container">
    <div class="col-md-3">
      <ol class="breadcrumb">
...
<div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="statics-title text-center">Terms of Us</h2>
      </div>
    </div>
    <div class="row" style="margin-bottom:30px;margin-top:20px">
      <div class="col-md-8 col-md-offset-2" style="font-family:'ubuntu';font-weight:normal">
