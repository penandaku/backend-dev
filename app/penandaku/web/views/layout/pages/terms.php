<div class="statics-page" style="background-image: url('<?php print cdn('img/wew.png') ?>'); position:relative;background-color:#333">
  <div class="container">
    <div class="col-md-3">
      <ol class="breadcrumb">
          <li><a href="<?php print base_url() ?>">Home</a></li>
          <li class="active">Terms of Us</li>
      </ol>
    </div>
  </div>
</div>
